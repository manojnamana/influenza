      ...
      <div className="min-h-screen bg-black relative overflow-x-hidden">
        ...
        >
          <section id="hero" className="container mx-auto px-4 lg:px-8 py-32">
            <div className="max-w-6xl mx-auto text-center space-y-12">
              <FadeInSection direction="up" distance={100}>
                <motion.h1
              ...
              <FadeInSection direction="up" delay={0.3} distance={80}>
                <motion.p
        ...
        >
          <section id="discover" className="container mx-auto px-4 lg:px-8">
            <ScrollScaleSection scaleFrom={0.9} scaleTo={1}>
        ...
        >
          <section id="cta" className="container mx-auto px-4 lg:px-8">
            <ScrollScaleSection scaleFrom={0.85} scaleTo={1}>
                ...
                <div className="max-w-5xl mx-auto space-y-12 relative z-10">
                  <FadeInSection direction="up" distance={60}>
                    <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-balance leading-tight">
                      <ScrollRevealText className="inline text-white">
                        Ready to transform your
                      </ScrollRevealText>{" "}
                      <ScrollRevealText className="inline bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
                        influencer marketing?
                      </ScrollRevealText>
                    </h2>
                  </FadeInSection>
                  <FadeInSection direction="up" delay={0.2} distance={40}>
                  ...
                  <FadeInSection direction="up" delay={0.4} distance={40}>
        ...
        >
          <footer className="border-t border-white/5">
            <div className="container mx-auto px-4 lg:px-8 py-20">
              <StaggerCards className="grid md:grid-cols-4 gap-16" stagger={0.1}>
